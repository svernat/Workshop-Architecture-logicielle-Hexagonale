...
class HexagonalApplicationTests {
    ...
    @Autowired
    private HexagonalApplication.ArticleRepository articleRepository;

    @Autowired
    private HexagonalApplication.StockRepository stockRepository;

    @Autowired
    private HexagonalApplication.OrderRepository orderRepository;

    @Autowired
    private HexagonalApplication.ArticlesInOrderRepository articlesInOrderRepository;

    @BeforeEach
    void cleanDatabase() {
        articlesInOrderRepository.deleteAll();
